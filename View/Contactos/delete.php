...
<p style="text-align:center;" >
	<button onclick="window.location.href = '/~eb50946/TC5_BD/?action=index';">Cancelar</button> 
</p>

<form name="sure" id="sure" method="post" action="/~eb50946/TC5_BD/?id=<?php echo $contact->id?>">
